$(document).ready(function(){
	...
	function LoadUser(){
		$.ajax({type: "POST", url: "../php/FEX_ADMIN_USER.php", async: true, data: {a0: 1}})
		.done(function(stream) {
			...
			data.forEach(function(element, index, array){
				...
				$("#listadoregistros2_tr_"+index).append("<td><img src='../img/user/" + element['FOTO'] + "'width='60' class='brand-image img-circle elevation-3' height='60'><p>"+element['PERSONA']+"</p></td>");
